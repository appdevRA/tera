# Generated by Django 3.2.6 on 2021-11-26 09:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person2persons', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2021, 11, 26, 9, 6, 0, 411328, tzinfo=utc))),
            ],
            options={
                'db_table': 'Practice',
            },
