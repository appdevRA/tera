# Generated by Django 3.1.1 on 2021-11-19 04:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2021, 11, 19, 12, 33, 26, 69843))),
            ],
            options={
                'db_table': 'Practice',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(default=datetime.datetime(2021, 11, 19, 12, 33, 26, 48662))),
                ('first_name', models.CharField(max_length=100)),
                ('last_name', models.CharField(max_length=100)),
                ('email', models.CharField(default='', max_length=100)),
                ('is_staff', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=False)),
                ('date_joined', models.DateTimeField(default=datetime.datetime(2021, 11, 19, 12, 33, 26, 48662))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateAccessed', models.DateTimeField(default=datetime.datetime(2021, 11, 19, 12, 33, 26, 64390))),
                ('dateAdded', models.DateTimeField(default=datetime.datetime(2021, 11, 19, 12, 33, 26, 64390))),
